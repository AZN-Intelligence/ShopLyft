  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="text-8xl font-bold text-orange-600 mb-6 leading-tight"
      >
        SHOPLYFT
      </motion.h1>
      ...
      <motion.h2
        ...
        className="text-4xl font-semibold text-orange-500 mb-10 leading-relaxed"
      >
        Groceries as a steal! ✨
      </motion.h2>
